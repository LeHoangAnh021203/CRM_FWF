    ...
    <div className="container mx-auto p-6">
      ...
      <Tabs defaultValue="calendar" className="space-y-6 ">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 bg-orange-100 overflow-x-auto">
          <TabsTrigger value="calendar" className="text-xs sm:text-sm">Lịch làm việc</TabsTrigger>
          <TabsTrigger value="shifts" className="text-xs sm:text-sm">Danh sách ca</TabsTrigger>
          <TabsTrigger value="approval" className="text-xs sm:text-sm">Phê duyệt</TabsTrigger>
          <TabsTrigger value="employees" className="text-xs sm:text-sm">Nhân viên</TabsTrigger>
          <TabsTrigger value="templates" className="text-xs sm:text-sm">Mẫu ca làm</TabsTrigger>
          <TabsTrigger value="reports" className="text-xs sm:text-sm">Báo cáo</TabsTrigger>
        </TabsList>

        <TabsContent value="calendar" className="space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 className="text-lg sm:text-xl font-semibold">Lịch theo chi nhánh</h2>
            <Button
            ...
            <div className="xl:col-span-1">
              <Card className="h-fit">
                ...
                <CardContent className="pt-0">
                  <ShiftList
                    shifts={shifts.filter(shift => shift.date === selectedDate.toLocaleDateString('en-CA'))}
                    onEdit={openEditForm}
        ...
        <TabsContent value="shifts">
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <CardTitle className="text-lg sm:text-xl">Tất cả ca làm việc</CardTitle>
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                  <Button onClick={() => setShowShiftForm(true)} className="w-full sm:w-auto">
                    <Plus className="w-4 h-4 mr-2" />
                    Thêm ca làm
                  </Button>
                  <Button 
