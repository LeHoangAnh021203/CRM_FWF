      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg mb-6">
          ...
          <div className="space-y-2">
            ...
            <p><strong>Mock Auth Enabled:</strong> {String(mockEnabled)}</p>
          </div>
        </div>

        <div className="bg-white rounded-lg p-6 shadow-lg mb-6">
          <h2 className="text-xl font-semibold mb-4">Mock Authentication Control</h2>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg">
          ...
          <div className="space-y-2">
            ...
            <a href="/dashboard/customers" className="block text-blue-600 hover:underline">Customers</a>
            <a href="/dashboard/accounting" className="block text-blue-600 hover:underline">Accounting</a>
